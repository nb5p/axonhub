...
import { ApiKeyActivityHeatmap } from './components/api-key-activity-heatmap';
  ...
  return (
    <div className='flex-1 space-y-6 p-8 pt-6'>
      ...
      <CollapsibleSection title={t('dashboard.sections.apiKeys')} icon={<Key className='text-primary h-4 w-4' />} storageKey='apiKeys'>
        ...
        <Card className='hover-card'>
          <CardHeader>
            <CardTitle>{t('dashboard.charts.apiKeyActivityHeatmap')}</CardTitle>
            <CardDescription>{t('dashboard.charts.apiKeyActivityHeatmapDescription')}</CardDescription>
          </CardHeader>
          <CardContent>
            <ApiKeyActivityHeatmap />
          </CardContent>
        </Card>
      </CollapsibleSection>
