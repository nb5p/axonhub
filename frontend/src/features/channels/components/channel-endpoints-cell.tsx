        ...
        <Tooltip key={endpoint.apiFormat}>
          <TooltipTrigger asChild>
            <span
              ...
              className={cn(
                'inline-flex h-6 min-w-8 cursor-help items-center justify-center rounded-sm border px-2 font-mono text-xs font-semibold',
                endpoint.className
              )}
            >
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <span
              ...
              className='bg-muted text-muted-foreground inline-flex h-6 min-w-8 cursor-help items-center justify-center rounded-sm border px-2 text-xs font-semibold'
            >
              …
            </span>
          </TooltipTrigger>
