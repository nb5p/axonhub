        ...
        <Tooltip key={endpoint.apiFormat}>
          <TooltipTrigger asChild>
            <span
              ...
              className={cn(
                'inline-flex h-7 w-7 cursor-help items-center justify-center rounded-sm border font-mono text-sm leading-none font-semibold',
                endpoint.className
              )}
            >
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <span
              ...
              className='bg-muted text-muted-foreground inline-flex h-7 w-7 cursor-help items-center justify-center rounded-sm border text-sm leading-none font-semibold'
            >
              …
            </span>
          </TooltipTrigger>
