...
var (
	...
	ProviderQuotaStatusColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "deleted_at", Type: field.TypeInt, Default: 0},
		{Name: "provider_type", Type: field.TypeEnum, Enums: []string{"claudecode", "codex", "xai_subscription", "github_copilot", "nanogpt", "cline", "wafer", "synthetic", "neuralwatt", "apertis", "opencode_go", "kimi_code", "minimax", "zhipu", "charm_hyper", "usage_query"}},
	...
	RequestsColumns = []*schema.Column{
		...
		{Name: "client", Type: field.TypeEnum, Enums: []string{"unknown", "other", "codex"}, Default: "unknown"},
		{Name: "model_id", Type: field.TypeString},
