...
local:
  ...
  commits:
    ...
    - 132b74b1b877b191f3812577936b4359264e23d8
    - f90b4dcfdc778702e76bac5af499dd5e27c2d4fd
  modules:
...
- 渠道“模型映射”对话框只提供手工后缀标签输入，以及“自动裁剪冒号”和“自动裁剪短线”两个复选框。自动提取与清空操作仅属于前缀，不作用于后缀。
- 前缀的“自动提取”和“清空”始终可见：没有可识别前缀时前者禁用，未选择任何前缀时后者禁用，不因支持模型没有 `/` 而隐藏整组操作。
...
| 2026-08-22 | 本地 UI 回归修复 | `132b74b1b877b191f3812577936b4359264e23d8` | 移除后缀的自动提取、候选与清空操作，恢复前缀专属的自动提取和清空按钮位置。 |
| 2026-08-22 | 本地 UI 可见性修复 | `f90b4dcfdc778702e76bac5af499dd5e27c2d4fd` | 前缀操作不再受可提取前缀数量控制；按钮始终显示，并按各自是否可执行禁用。 |
