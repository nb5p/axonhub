...
local:
  ...
  commits:
    ...
    - d04464eeaabe0a5130d9f2a0667e746de8882f6c
  modules:
...
- 主端点使用 `C`、`R`、`M`、`G` 的 28×28、6px 圆角正方形徽标，字母大小为 14px，并按 OpenAI、Anthropic、Gemini 使用不同颜色。
...
| 2026-08-11 | 本地反馈 | `d04464ee` | 调整为 28×28、6px 圆角正方形，并将字母增大到 14px。 |
