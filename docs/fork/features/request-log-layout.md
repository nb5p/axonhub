...
- 手机窄屏不再压缩桌面表格，而是使用请求卡片展示核心字段和当前列设置允许的附加字段；筛选、分页和请求详情同时采用移动端专用布局。
...
- 2026-08-12 移动卡片回归断言、前端 22 个单元测试和 TypeScript 检查通过；390×844 触摸视口无横向溢出。
...
| 2026-08-12 | 用户移动端反馈 | `82d825f9086f7477b2a0836af559dcdcd0de7385` | 请求日志改用移动卡片，请求详情、筛选和分页按窄屏重新布局。 |
